...
if($query->num_rows > 0)
{
    while($result = $query->fetch_array())
    {
        ...
        $nestedData[] = "<input type='number' onchange=\"lengthWidth('".$partId."', '".$workingQuantity."', this.value, 'length');\" data-part-id='".$partId."' class='length w3-input w3-border' name='matLength[]' value='".$matLength."' style='width:100px;' step='any' form='computeFormId'>";
        $nestedData[] = "<input type='number' onchange=\"lengthWidth('".$partId."', '".$workingQuantity."', this.value, 'width');\" data-part-id='".$partId."' class='width w3-input w3-border' name='matWidth[]' value='".$matWidth."' style='width:100px;' step='any' form='computeFormId'>";
