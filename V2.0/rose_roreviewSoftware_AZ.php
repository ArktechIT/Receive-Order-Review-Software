...
<body class='api-loading'>
	<div class="api-row">
		...
		<div class="api-top api-col api-right-buttons" style='width:30%'>
			<button class='api-btn api-btn-add' id='qwe' onclick="location.href='rose_roreviewList.php';" style='width:33%' data-api-title='<?php echo strtoupper(displayText('L2033')); ?>'></button>	<!-- HISTORY -->
		...
		<div class="api-col" style='width:100%;height:88vh;'>
				...
				<table id="table10" class="mytable" cellpadding="0" cellspacing="0">
						...
						for($i=0;$i<count($poIdArray);$i++)
						{
							...
							if(!$selectedItemQuery->num_rows > 0)
							{
								...
								echo "<tr class='rowCount'>";	
									if(in_array($processCodeFilterArray[$i],array(460,463)))//added by rose 2019-08-24
									{
									...
									echo "<td class='text-center'><a href='' onclick=\"window.open('/V3/16 Lot Details Management Software/ace_lotDetails.php?inputLot=".$lotNumberArray[$i]."', '_blank', 'toolbar=yes, scrollbars=yes, resizable=yes, top=100, left=100, width=1200, height=600')\" >".$lotNumberArray[$i]."</a></td>";
								...
								{
									$pdfDrawing = "<span style='color:blue;cursor:pointer;text-decoration:underline;' onclick=\" window.open('../Document Management System/gerald_viewPdf.php?file=Arktech Folder/ARK_".$partIdListArray[$i].".pdf','myWindow2','left=50,screenX=20,screenY=60,resizable,scrollbars,status,width=700,height=500'); return false;\"><img src='/V3/Common Data/Templates/images/view1.png' height='15'); \"></span>";
								}
								else
								{ 
									$pdfDrawing = ""; 
					...
					<tfoot>
						<tr>								
							...
							<th><input type='image' id='submitId' src="/V3/Common Data/Templates/buttons/addIcon.png" width='30' height='30' form='formId'/></th>
							<th></th>
							<th></th>
							<th></th>	
							<th></th>
				...
				<table id="table11" class="mytable" cellpadding="0" cellspacing="0">
							...
							//ROSE START 2019-11-15 use rhay code!!!!! if ano ang del date sa RO list un ang sususndin minus delType then color red if negative lead time //consulted by les
									...
									if($queryRoReviewDataTemp AND $queryRoReviewDataTemp->num_rows > 0)
									{
										...
										if($resultRoReviewDataTemp['changeDueDateFlag']==0)
										{
											...
											$sql = "UPDATE ppic_roreviewdatatemp SET dueDate = '".$str2."', deldate = '".$RosecustomerDeliveryDate."', deliveryType = '".$deliveryType."' WHERE poId = ".$poIdArray[$i]." LIMIT 1";
					...
					<tfoot>
						<tr>
							...
							<th><input type='image' id='deleteButton' src="/V3/Common Data/Templates/buttons/deleteIcon.png" width='30' height='30' form='formId'/></th>
							...
							<th></th>
							<th></th>
							<th><input type='button' onclick="location.href='/V3/54 Automated Material Computation Software/ace_viewSummarizedComputation.php'" value="<?php echo displayText('L3726'); ?>"></th> 
							<th></th>
							<th></th>
							<th></th>
							<th></th>
			...
			<div style='height: 55%; width: 20%; float:right; border:2px solid; border-radius:25px; background-color: white; '>
...
<?php
	$tWidth = 'auto';
?>
<link rel="stylesheet" href="/V3/Common Data/Libraries/Javascript/Table Filter/style2.css" type="text/css" media="screen" />
<link rel="stylesheet" type="text/css" href="/V3/Common Data/Libraries/Javascript/Table Filter/filtergrid3.css" />
...
<script src="/V3/Common Data/Libraries/Javascript/Table Filter/tablefilter_all_min.js" language="javascript" type="text/javascript"></script>
<script type="text/javascript" src="/V3/Common Data/Libraries/Javascript/Table Filter/sorttable.js"></script>
<script src="/V3/Common Data/Libraries/Javascript/Table Filter/scroll3.js"></script>
...
<script language="javascript" type="text/javascript">
    ...
    var table10_Props = {
                            ...
                            col_0: 'none',col_1: 'select',col_2: 'input',col_3: 'select',col_4: 'input',col_5: 'select',col_6: 'select',col_7: 'select',col_8: 'select',col_9: 'select',col_10: 'select',col_11: 'select',col_12: 'select',col_13: 'none',col_14: 'select',
