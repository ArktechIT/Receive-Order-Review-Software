						...
						for($i=0;$i<count($poIdArray);$i++)
						{
							...
							if(!$selectedItemQuery->num_rows > 0)
							{
								...
								echo "<tr class='rowCount'>";	
									...
									echo "<td class='text-center'><a href='' onclick=\"window.open('/".v."/16 Lot Details Management Software/ace_lotDetails.php?inputLot=".$lotNumberArray[$i]."', '_blank', 'toolbar=yes, scrollbars=yes, resizable=yes, top=100, left=100, width=1200, height=600')\" >".$lotNumberArray[$i]."</a></td>";
...
<link rel="styleshe<?php echo v; ?>" type="text/css" href="/<?php echo v; ?>/Common Data/Libraries/Javascript/Table Filter/filtergrid3.css" />
